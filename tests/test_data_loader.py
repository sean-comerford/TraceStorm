...
from tracestorm.data_loader import (
    load_datasets,
    Dataset
)
...
class TestDataLoader(unittest.TestCase):
    def test_local_files(self):
        ...
        datasets, sort = load_datasets("../tracestorm/datasets_config/datasets_config_local.json")
        assert isinstance(datasets, list)
        assert isinstance(datasets[0], Dataset) and isinstance(datasets[1], Dataset)
        assert sort == "random"
    ...
    def test_remote_files(self):
        ...
        """
        datasets, sort = load_datasets("../tracestorm/datasets_config/datasets_config_hf.json")
        assert isinstance(datasets, list)
        assert isinstance(datasets[0], Dataset) and isinstance(datasets[1], Dataset)
    ...
    def test_missing_fields(self):
        ...
        datasets, sort = load_datasets("../tracestorm/datasets_config/datasets_config_missing.json")
