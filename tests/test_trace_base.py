...
class TestAzureTraceGenerator(unittest.TestCase):
    ...
    @patch("tracestorm.trace_base.requests.get")
    ...
    @patch("tracestorm.trace_base.AzureTraceGenerator._download_file")
    @patch("tracestorm.trace_base.AzureTraceGenerator._process_dataset")
